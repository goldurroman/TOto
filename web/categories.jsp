...
<jsp:include page="header.jsp"></jsp:include>
	...
	<div class="home " style="height: 500px;">
		<div class="home_container " >
			<div class="home_background" style="height: 495px; background-image:url(Images/deco1.jpg)"></div>
							...
							<div class="sorting">
								<ul class="item_sorting">
									<li>
										...
										<ul>
                                                                                    <li class="product_sorting_btn" data-isotope-option='{ "sortBy": "original-order" }'><span><a href="MainServlet?artisanId=01">Savonerie seconde nature</a></span></li>
                                                                                    <li class="product_sorting_btn" data-isotope-option='{ "sortBy": "original-order" }'><span><a href="MainServlet?artisanId=02">Savon des Cantons</a></span></li>
...
<!--						 Product 
					...
					<div class="product_pagination">
						<ul>
							<li class="active"><a href="MainServlet?pageId=01">01.</a></li>
							<li><a href="MainServlet?pageId=02">02.</a></li>
							<li><a href="MainServlet?pageId=03">03.</a></li>
						</ul>
					</div>
