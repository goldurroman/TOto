...
<header class="header">
                    ...
                    <div class="header_content d-flex flex-row align-items-center justify-content-start">
                        ...
                        <nav class="main_nav">
                            <ul>
                                ...
                                <li><a href="contact.html">Contact</a></li>
                                    <c:choose>
                                        <c:when test="${requestScope.clientConnecte.nom==null}">
                                        <li><a href="login.jsp">Login <img class="login_img"  src="Images/login.jpg"></a></li>
                                            </c:when>
                                            <c:otherwise>
                                        <li>${requestScope.clientConnecte.prenom} </li> 
                                        </c:otherwise>
                                    </c:choose>
                ...
                <div class="col">
                    <div class="search_panel_content d-flex flex-row align-items-center justify-content-end">
                        <form action="MainServlet">
                            <input id = "choix"  type="text" class="search_input" placeholder="Search" required="required">
    ...
    <script>
        ...
        $("#choix").easyAutocomplete(options);
