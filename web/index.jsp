			...
			<div class="row">
				<div class="col">
					...
					<div class="product_grid">
						...
						<div class="product">
							<div class="product_image"><img src="${produit.photoProduit}" alt=""></div>
							<div class="product_content">
								<div class="product_title"><a href="product.html">${produit.codeProduit}</a></div>
								<div class="product_price">$${produit.prixProduit}</div>
							</div>
						</div>
</c:forEach>
						<!-- Product -->
